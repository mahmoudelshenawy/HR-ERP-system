...
class OverTimesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('employee', 'salary.over_time.datatable-columns.employee')
            ->addColumn('action', 'salary.over_time.datatable-columns.action')
    ...
    {
        return $this->builder()
            ->setTableId('OverTimeDataTable-table')
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                ...
                'title' => trans('salary.over_time_amount'),
                "orderable" => false,
                "exportable" => false,
                "printable" => false,
                'sortable' => false,
