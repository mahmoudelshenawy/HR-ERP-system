<div id="add_absence_delay_excel" class="modal custom-modal fade" role="dialog">
...
<div class="modal-body">
    <form action="{{ url('salary/absence_delay_penalty/import') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-6">
